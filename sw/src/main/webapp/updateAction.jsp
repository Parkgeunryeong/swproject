...
<body>
   ...
   if (!userID.equals(community.getUserID())) {
      ...
      if (request.getParameter("com_title") == null || community.getCom_content() == null
            || request.getParameter("com_title").equals("") || request.getParameter("com_content").equals("")) {
         PrintWriter script = response.getWriter();
         script.println("<script>");
         ...
         int result = communityDAO.update(com_id, request.getParameter("com_title"), request.getParameter("com_content"));
         if (result == -1) {
            PrintWriter script = response.getWriter();
            script.println("<script>");
